...
check(str_contains($travelSql, "IN ('within_range','included_exception')"), 'Nur Zeitradius und ausdrücklich einbezogene Orte dürfen durch den Regionalfilter.');
check(str_contains($travelSql, "='included_exception' OR"), 'Regionale Ausnahmen müssen unabhängig vom Zeitlimit freigegeben werden.');
